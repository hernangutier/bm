...
<div class="container">
    ...
    <?php $form = ActiveForm::begin(); ?>
     ...
     <?php //-------------- Contactos -------------
       ...
       echo $form->field($model, 'codgen')->widget(Select2::classname(), [

            'data' => ArrayHelper::map(app\models\SdbCategoriasGeneral::find()->all(),'cod',
            ...
            'options' => ['placeholder' => 'Seleccione Categoria General ...'],
            'pluginOptions' => [
            'allowClear' => true
            ],
