  ...
  <div class="desincorporaciones-bm-form">
    ...
    <div class="widget-box">
    									<div class="widget-header widget-header-blue widget-header-flat">
    										<h4 class="widget-title lighter">Traspaso de Bienes entre Usuarios</h4>
    												...
    												<div>
    													<ul class="steps">
    														<li data-step="1" class="active">
    															...
    															<span class="title">Datos de Origen y Usuario</span>
    														</li>
                              ...
                              <?php $form = ActiveForm::begin(); ?>
                                ...
                                <?=
                                    $form->field($model, 'coduser_origen')->widget(Select2::classname(), [
                                          ...
                                          'options' => ['placeholder' => 'Seleccione Usuario a Desa ...'],
                                          'pluginOptions' => [
                                              'allowClear' => true
                                          ],
                                        ]);
                                ...
                                <?=
                                    $form->field($model, 'coduser_destino')->widget(Select2::classname(), [
                                          'data' => ArrayHelper::map(app\models\Responsables::getListSqlActives(), 'cod', 'resultado'),
                                          'options' => ['placeholder' => 'Seleccione Origen de los Bienes ...'],
                                          'pluginOptions' => [
                                              'allowClear' => true
                                          ],
                                        ]);
