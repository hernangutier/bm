...
<div class="desincorporaciones-bm-form">
  ...
  <div class="widget-box">
  									<div class="widget-header widget-header-blue widget-header-flat">
  										<h4 class="widget-title lighter">Aperturar Desincorporación</h4>
  											...
  											<div id="fuelux-wizard-container">
  												...
  												<div class="step-content pos-rel">
  													<div class="step-pane active" data-step="1">
  														<h3 class="lighter block green">Registrar Desincorporación N°: <?= $model->ncontrol ?>  </h3>
                              ...
                              <?=
                                  $form->field($model, 'concepto')->widget(Select2::classname(), [
                                        'data' => ArrayHelper::map(app\models\DesincorporacionesConceptos::find()->asArray()->all(), 'cod', 'descripcion'),
