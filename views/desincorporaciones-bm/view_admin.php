...
<div class="container">
  ...
  <div class="btn-group">
        <?php
                if ($model->status==1){
                    echo '<a href="'. Url::to(['/desincorporaciones-bm/confirmar','id'=>$model->cod]) .'" class="btn btn-success">
                                            <i class="ace-icon fa  fa-thumbs-o-up align-top bigger-125"></i>
                                            Confirmar
                    </a>';
                }
                if ($model->status==1 || $model->status==0){
                    ...
                    echo '  <a href="'. Url::to(['/desincorporaciones-bm/anular','id'=>$model->cod]) .'" class="btn btn-danger">
...
<h4 class="blue">
  ...
  <div class="profile-user-info profile-user-info-striped">
    ...
    <?php
          if ($model->getDesincorporacionesDts()->count()>0){
