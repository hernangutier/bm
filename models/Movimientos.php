  ...
  const SCENARIO_PERMUTAR = 'permutar';
    ...
    public function rules()
    {
        return [
            ...
            [['fecha','codund_origen','coduser_destino'], 'required', 'on'=> self::SCENARIO_ASIGNAR],
            [['fecha','codund_origen','codund_destino'], 'required', 'on'=> self::SCENARIO_TRASLADAR_UND],
            [['fecha','coduser_origen','coduser_destino'], 'required', 'on'=> self::SCENARIO_TRASLADAR],
            [['fecha','coduser_origen','codund_destino','estado_uso'], 'required', 'on'=> self::SCENARIO_DESVINCULAR],
